...
\begin{defi}\label{def:group3}
	  ...
	  %This means that $H$ must satisfies the following three conditions:
	  %\begin{enumerate}
	  %      \item $1 \in H$,
...
\begin{defi}\label{def:ring2}
      Let $(R,+, \cdot)$ be a ring. Let $S$ be a subset of $R$ and suppose that $(S,+, \cdot)$ is also a ring. Then, we say that $S$ is a subring of $R$ 
