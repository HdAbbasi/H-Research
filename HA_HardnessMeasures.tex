...
%This means that the hardness is the height of the biggest full splitting tree which can be embedded into each tree-like resolution refutation of the formula.
