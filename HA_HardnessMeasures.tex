...
%The optimal move for Delayer is to keep hd not changed and the worst case for Delayer is when it can not prevent prover from achieving two points or more. thus, in each round hd remains unchanged or decreased exactly one unit.  
